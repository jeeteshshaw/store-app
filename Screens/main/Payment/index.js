  ...
  return(
    <ScrollView scrollEnabled={true}  style={{flex:1, backgroundColor:'white'}}>
      ...
      <View >
        ...
        <Rtext style={{paddingLeft:10, marginBottom:10}} fontSize={15} fontWeight='700'>Cash on Delivery</Rtext>
        {/* Cash on Delivery  */}
        <View style={{flexDirection:'row'}}>
          ...
          <View style={{ paddingTop:20,paddingLeft:10}}>
            ...
            <GButton press={newUpdate} style={{height:normalizeSize(24), width:normalizeSize(80),borderRadius:4,alignSelf:'flex-start'}} textStyle={{fontSize:13}} data="Place Order"/>
            </View>
          </View>
        </View>
        </View>
        ...
        <View style={[Styles.card,{marginTop:10,height:deviceHeight/3.5,}]}>
          <Rtext style={{paddingLeft:10,paddingTop:10}} fontSize={15} fontWeight='700'>UPI</Rtext>
          <View style={{flexDirection:'row',paddingLeft:10}}>
            ...
            <View style={{alignSelf:'center',paddingLeft:normalizeSize(130)}}>
          ...
          <View style={{flexDirection:'row',paddingLeft:10,justifyContent:'flex-start', alignItems:'center'}}>
            ...
            <View style={{alignSelf:'center',paddingLeft:normalizeSize(120)}}>
            <Image source={require('../../../assets/icons/arrow_right.png')} style={{ height:15,width:15,resizeMode:'contain',color:'#A7A7A7'}} />
            </View>
          </View>
        ...
        <View style={[Styles.card,{marginTop:10, paddingBottom:normalizeSize(30)}]}>
          <Rtext style={{paddingLeft:10,paddingTop:10}} fontSize={15} fontWeight='700'>Card</Rtext>
          <View style={{flexDirection:'row', marginTop:10,paddingLeft:10}}>
            ...
            <View style={{alignSelf:'center',paddingLeft:normalizeSize(29)}}>
            <Image source={require('../../../assets/icons/arrow_right.png')} style={{ height:15,width:15,resizeMode:'contain',color:'#A7A7A7'}} />
            </View>
          </View>
        </View>
        ...
        <View style={[Styles.card,{marginTop:10}]}>
          <Rtext style={{paddingLeft:10,paddingTop:10}} fontSize={15} fontWeight='700'>Net Banking</Rtext>
          <View style={{flexDirection:'row', marginTop:10,paddingLeft:10}}>
            ...
            <View style={{marginHorizontal:normalizeSize(120),paddingTop:25}}>
            <Image source={require('../../../assets/icons/arrow_right.png')} style={{ height:15,width:15,resizeMode:'contain',color:'#A7A7A7'}} />
            </View>
          </View>
        </View>
