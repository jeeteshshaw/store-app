      ...
      <View >
        ...
        <View style={[Styles.card,{marginTop:10,height:deviceHeight/3.5,}]}>
          ...
          <View style={{flexDirection:'row',paddingLeft:10}}>
            <Image source={require('../../../assets/images/Phone_Pay.png')}  style={{height:80, width:120,resizeMode:"contain",paddingLeft:10}} />
        ...
        <View style={[Styles.card,{marginTop:10, paddingBottom:10}]}>
          <Rtext style={{paddingLeft:10}} fontWeight='700'>Card</Rtext>
          <View style={{flexDirection:'row', marginTop:10,paddingLeft:10}}>
            <Image source={require('../../../assets/images/Card.png')} style={{height:80, width:120,resizeMode:"contain"}}/>
        ...
        <View style={[Styles.card,{marginTop:10}]}>
          ...
          <View style={{flexDirection:'row', marginTop:10,paddingLeft:10}}>
            <Image source={require('../../../assets/images/NetBanking.png')} style={{height:80, width:120,resizeMode:"contain"}}/>
